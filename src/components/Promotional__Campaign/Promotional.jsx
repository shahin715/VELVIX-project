...
const allProducts = [
  ...
  },
  {
    id: 2,
    title:
      "Dual Band Tenda U9 11AC USB WiFi Adapter - AC650 Wireless Network Card",
    price: "22",
    image: Img2,
  },
  {
    id: 3,
    title: "Galax Vivance-24F Gaming Monitor, 24 FHD Fast IPS Display",
    price: "110",
    image: Img3,
  },
  {
    id: 4,
    title: "Plustek OpticSlim 2610 Pro A4 flatbed Scanner 1200 dpi Resolution",
    price: "52",
    image: Img4,
  },
];
  ...
  return (
    <div style={{ marginTop: "40px" }}>
      <ProductGrid
        ...
        columns={4}
        linkTo={(product) =>
          `${routePaths.ROUTE_PROMOTIONALDETAILS}/${product.id}`
        }
      />
    </div>
  );
